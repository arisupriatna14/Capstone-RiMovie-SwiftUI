...
public struct ClassDicodingMapper: Mapper {
  ...
  public func transformDomainToPresentation(domain: [ClassDicodingModel]) -> [ClassDicodingUIModel] {
    return domain.map {
  ...
  public func transformPresentationToDomain(presentation: [ClassDicodingUIModel]) -> [ClassDicodingModel] {
    fatalError()
  }
